...
import com.jmsmart.whosecat.Dialog.YearMonthPickerDialog;
...
import com.jmsmart.whosecat.formatter.MonthAxisValueFormatter;
...
public class FragmentAnalysisMonthViewModel extends FragViewModel {
    ...
    public FragmentAnalysisMonthViewModel(final AppCompatActivity activity, FragmentAnalysisMonthBinding binding){
    ...
    public void calendarClick(){
        ...
        yearMonthPickerDialog.setListener(listener);
        yearMonthPickerDialog.show( activity.getSupportFragmentManager(), "YearAnd");
    }
    ...
    private DatePickerDialog.OnDateSetListener listener = new DatePickerDialog.OnDateSetListener() {
        ...
        public void onDateSet(DatePicker view, int year, int monthOfYear, int dayOfMonth) {
            ...
            //setTvDate(selectedDate);
            isFirst=true;
            getPetMonthData(MainActivity.listIndex, selectedDate);
        }
    };
    ...
    private void setData() {
        ...
        ValueFormatter xAxisFormatter = new MonthAxisValueFormatter(binding.chart);
    ...
    private void makeEntries(){
        for(PetData petData : listPetDayData){
            ...
            data.add(new BarEntry(c.get(Calendar.DATE), Float.valueOf(petData.getPetDate(VAL_LIST[index])), c.getTimeInMillis()));
        }
    ...
    private void getPetMonthData(int listIndex, Date requestDate){
        Date frontDate = new Date();
        frontDate.setTime(requestDate.getTime());
        frontDate.setHours(23);
        frontDate.setMinutes(59);
        frontDate.setSeconds(59);
        Calendar calendar = Calendar.getInstance();
        calendar.setTime(frontDate);
        frontDate.setDate(calendar.getActualMaximum(Calendar.DAY_OF_MONTH));
        ...
        AnalysisData analysisData = new AnalysisData(MainActivity.listPetInfo.get(listIndex).petID,rearDate.getTime(), frontDate.getTime());
